    ...
    <>
      ...
      <li>
        ...
        <div
          id="dropdownNavbar"
          className={`z-10 ${
            isAnonmyousOpen ? "block md:absolute" : "hidden"
          } mt-1 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}
        >
          <ul
            className="py-2 text-sm text-gray-700 dark:text-gray-400"
            aria-labelledby="dropdownLargeButton"
